...
export class TrackPackage extends Component {
  constructor(props) {
    super(props);
  }
  /* componentWillMount() {
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-md-12 topbarContent">
            <h1>This is Order Tracking page</h1>
          </div>
        </div>
          ...
          <div className="col-md-8 textColorBlack">
            ...
            <div className="card textColorBlack">
              <div className="card-header">
                <b>
                  Track Package! Order # : {this.props.order.orderId} Product #
                  : {this.props.product.name}
                </b>
              </div>
              <div className="card-body">Your Order can be tracked here!..</div>
            </div>
          </div>
